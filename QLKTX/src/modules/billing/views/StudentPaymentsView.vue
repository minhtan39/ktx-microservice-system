...
.page-heading h2, .section-title h3, .detail-header h3 { margin: 0; color: #24150e; }
.page-heading h2 { font-size: 30px; }
.page-heading p, .section-title p { margin: 5px 0 0; color: #7a6a5d; }
.eyebrow, .detail-header > div > span { color: #c2410c; font-size: 12px; font-weight: 900; }
.summary-band { display: grid; grid-template-columns: 2fr 1fr 1fr; border: 1px solid #f4ded0; border-radius: 8px; background: #fff; }
.summary-band div { display: grid; gap: 5px; padding: 20px; border-right: 1px solid #f4ded0; }
.summary-band div:last-child { border-right: 0; }
.summary-band span { color: #68766e; }
.summary-band strong { color: #c2410c; font-size: 28px; }
.wallet-panel { display: grid; gap: 18px; padding: 22px; border: 1px solid #f4ded0; border-radius: 8px; background: #fff; }
.wallet-main { display: flex; align-items: center; justify-content: space-between; gap: 18px; padding: 18px; border-radius: 8px; background: linear-gradient(135deg, #fff3e8, #fffaf5); }
.wallet-main > div { min-width: 0; }
.wallet-main h3 { margin: 5px 0 4px; color: #24150e; font-size: 22px; }
.wallet-main strong { display: block; color: #c2410c; font-size: 34px; line-height: 1.15; }
.wallet-main p { max-width: 620px; margin: 6px 0 0; color: #7a6a5d; }
.wallet-grid { display: grid; grid-template-columns: minmax(0, 1.1fr) minmax(320px, .9fr); gap: 16px; }
.topup-box, .wallet-history { padding: 18px; border: 1px solid #f4ded0; border-radius: 8px; background: #fffaf5; }
...
.wallet-transfer { display: grid; grid-template-columns: 150px minmax(0, 1fr); gap: 16px; align-items: center; margin-top: 14px; padding: 14px; border: 1px dashed #fdba74; border-radius: 8px; background: #fff7ed; }
...
.wallet-transfer strong { color: #c2410c; font-size: 20px; overflow-wrap: anywhere; }
.copy-note { display: block; color: #c2410c !important; font-weight: 700; }
...
.wallet-history article > .mdi { color: #f36f21; font-size: 25px; }
...
.wallet-history b { color: #c2410c; white-space: nowrap; }
...
.invoice-list, .invoice-detail, .history-panel { padding: 22px; border: 1px solid #f4ded0; border-radius: 8px; background: #fff; }
.section-title { margin-bottom: 18px; }
.section-title > div { justify-content: flex-start; }
.section-title .mdi { display: grid; place-items: center; width: 42px; height: 42px; border-radius: 7px; background: #fff3e8; color: #f36f21; font-size: 23px; }
...
.grand-total strong { color: #c2410c; }
...
.transfer-note { padding: 15px; border: 1px dashed #fdba74; border-radius: 7px; background: #fff7ed; text-align: center; }
...
.transfer-note strong { color: #c2410c; font-size: 20px; }
...
.history-grid article > .mdi { color: #f36f21; font-size: 24px; }
.history-grid article > div { flex: 1; display: grid; }
.history-grid small { color: #748077; }
.history-grid b { color: #c2410c; }
